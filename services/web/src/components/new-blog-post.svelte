...
<div class="mt-6">
    <form>
        <InputGroup elementType="input" label="Title" errorMessage="Please provide a title." hasError={!title} id="title" placeholder="Untitled" bind:value={title} />
        <InputGroup elementType="textarea" label="Content" errorMessage="Please provide content."  hasError={!content} id="content" placeholder="Your content..." bind:value={content} />
